    ...
    if 'search' in request.GET:
        ...
        if form.is_valid():
            ...
            if str(request.user) != "AnonymousUser":
                ...
                context = {
                            'form':form, 'movie_id_list': movie_id_list,
                            ...
                            'range': range(1, total_pages+1), 'search': search
                        }
            else:
                context = {
                            'form':form, 'movie_id_list': movie_id_list,
                            'poster_img_urls': poster_img_urls, 'total_results': total_results,
                            'zipped_id_poster_backdrop_title_vote_genres_overview_date': zipped_id_poster_backdrop_title_vote_genres_overview_date,
                            'page_number': page_number,'total_pages': total_pages, 'range': range(1, total_pages+1), 'search': search
                        }
